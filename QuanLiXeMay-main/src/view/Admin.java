...
//        pf.checkRole(currentAcc);
        ...
        ClickedColor = new Color(103,109,124);
    ...
    private void initComponents() {
        ...
        setTitle("Phẩn mềm quản lý kho xe máy");
        ...
        SanPham.setBackground(new java.awt.Color(57, 62, 70));
        ...
        jLabel1.setFont(new java.awt.Font("iCiel Gotham Medium", 1, 15)); // NOI18N
        ...
        NavbarMenu.add(SanPham, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 220, 190, 40));
        ...
        jLabel2.setFont(new java.awt.Font("iCiel Gotham Medium", 1, 15)); // NOI18N
        ...
        NavbarMenu.add(NhapHang, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 300, 190, 40));
        ...
        jLabel3.setFont(new java.awt.Font("iCiel Gotham Medium", 1, 15)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("PHIẾU NHẬP");
        jLabel3.setMaximumSize(new java.awt.Dimension(102, 18));
        jLabel3.setMinimumSize(new java.awt.Dimension(102, 18));
        jLabel3.setPreferredSize(new java.awt.Dimension(102, 18));
        ...
        NavbarMenu.add(PhieuNhap, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 340, 190, 40));

        XuatHang.setBackground(new java.awt.Color(57, 62, 70));
        ...
        jLabel4.setFont(new java.awt.Font("iCiel Gotham Medium", 1, 15)); // NOI18N
        ...
        NavbarMenu.add(XuatHang, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 380, 190, 40));
        ...
        jLabel5.setFont(new java.awt.Font("iCiel Gotham Medium", 1, 15)); // NOI18N
        ...
        NavbarMenu.add(DangXuat, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 650, 190, 40));

        NhaCungCap.setBackground(new java.awt.Color(57, 62, 70));
        ...
        jLabel6.setFont(new java.awt.Font("iCiel Gotham Medium", 1, 15)); // NOI18N
        ...
        NavbarMenu.add(NhaCungCap, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 260, 190, 40));

        NameUser.setBackground(new java.awt.Color(0, 0, 0));
        NameUser.setFont(new java.awt.Font("iCiel Gotham Medium", 0, 15)); // NOI18N
        ...
        NavbarMenu.add(NameUser, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 150, 110, 20));

        PhieuXuat.setBackground(new java.awt.Color(57, 62, 70));
        ...
        jLabel9.setFont(new java.awt.Font("iCiel Gotham Medium", 1, 15)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("PHIẾU XUẤT");
        jLabel9.setMaximumSize(new java.awt.Dimension(101, 18));
        jLabel9.setMinimumSize(new java.awt.Dimension(101, 18));
        jLabel9.setPreferredSize(new java.awt.Dimension(101, 18));
        ...
        NavbarMenu.add(PhieuXuat, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 420, 190, 40));

        TonKho.setBackground(new java.awt.Color(57, 62, 70));
        TonKho.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        TonKho.setPreferredSize(new java.awt.Dimension(190, 40));
        ...
        jLabel10.setFont(new java.awt.Font("iCiel Gotham Medium", 1, 15)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("TỒN KHO");
        jLabel10.setMaximumSize(new java.awt.Dimension(77, 18));
        jLabel10.setMinimumSize(new java.awt.Dimension(77, 18));
        jLabel10.setPreferredSize(new java.awt.Dimension(77, 18));
        ...
        Account.setPreferredSize(new java.awt.Dimension(190, 40));
        ...
        jLabel14.setFont(new java.awt.Font("iCiel Gotham Medium", 1, 15)); // NOI18N
        ...
        NavbarMenu.add(Account, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 610, 190, 40));

        jButtonAboutus.setBackground(new java.awt.Color(238, 238, 238));
        jButtonAboutus.setFont(new java.awt.Font("iCiel Gotham Medium", 1, 12)); // NOI18N
        jButtonAboutus.setText("About us");
        jButtonAboutus.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        jButtonAboutus.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButtonAboutusMouseClicked(evt);
            }
        });
        ...
        NavbarMenu.add(jButtonAboutus, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 700, 140, 30));
        NavbarMenu.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 200, 190, 10));
    ...
    private void jButtonAboutusMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonAboutusMouseClicked
        // TODO add your handling code here:
