...
public class UpdatePhieuXuat extends javax.swing.JDialog {
    ...
    public XeMay findMayTinh(String MaXe) {
        ...
        try {
            ...
            for (int i = 0; i < CTPhieu.size(); i++) {
                tblNhapHangmd.addRow(new Object[]{
                    i + 1, CTPhieu.get(i).getMaXe(), findMayTinh(CTPhieu.get(i).getMaXe()).getTenXe(), CTPhieu.get(i).getSoLuong(), formatter.format(CTPhieu.get(i).getDonGia()) + "đ"
                });
            }
        } catch (Exception e) {
        }
    ...
    private void initComponents() {
        ...
        btnNhapHang.setFont(new java.awt.Font("SF Pro Display", 0, 12)); // NOI18N
        ...
        deleteProduct.setFont(new java.awt.Font("SF Pro Display", 0, 12)); // NOI18N
        ...
        jButton1.setFont(new java.awt.Font("SF Pro Display", 0, 12)); // NOI18N
        ...
        addProduct.setFont(new java.awt.Font("SF Pro Display", 0, 12)); // NOI18N
    ...
    private void btnNhapHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNhapHangActionPerformed
        ...
        if (CTPhieu.isEmpty()) {
            ...
            for (var ct : CTPhieuOld) {
                XeMayDAO.getInstance().updateSoLuong(ct.getMaXe(), XeMayDAO.getInstance().selectById(ct.getMaXe()).getSoLuong() + ct.getSoLuong());
        ...
        if (i_row == -1) {
            ...
            if (newSL != null) {
                ...
                try {
                    ...
                    if (soLuong > findMayTinh(CTPhieu.get(i_row).getMaXe()).getSoLuong()) {
            ...
            if (soluongselect == 0) {
                ...
                if (soluongselect < soluong) {
                    ...
                    if (mtl != null) {
                        ...
                        XeMay mt = SearchProduct.getInstance().searchId((String) tblSanPham.getValueAt(i_row, 0));
                        ChiTietPhieu ctp = new ChiTietPhieu(phieuxuat.getMaPhieu(), mt.getMaXe(), soluong, mt.getGia());
                        CTPhieu.add(ctp);
                    }
                    loadDataToTableNhapHang();
                    textTongTien.setText(formatter.format(tinhTongTien()) + "đ");
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        ArrayList<XeMay> Mtkq = new ArrayList<>();
