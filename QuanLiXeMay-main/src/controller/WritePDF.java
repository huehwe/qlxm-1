    ...
    public void writePhieuNhap(String mapn) {
        ...
        try {
            ...
            for (ChiTietPhieu ctpn : ChiTietPhieuNhapDAO.getInstance().selectAll(mapn)) {
                XeMay xm = XeMayDAO.getInstance().selectById(ctpn.getMaXe());
                pdfTable.addCell(new PdfPCell(new Phrase(ctpn.getMaXe(), fontData)));
                pdfTable.addCell(new PdfPCell(new Phrase(xm.getTenXe(), fontData)));
                pdfTable.addCell(new PdfPCell(new Phrase(formatter.format(xm.getGia()) + "đ", fontData)));
                pdfTable.addCell(new PdfPCell(new Phrase(String.valueOf(ctpn.getSoLuong()), fontData)));
                pdfTable.addCell(new PdfPCell(new Phrase(formatter.format(ctpn.getSoLuong() * xm.getGia()) + "đ", fontData)));
            }
