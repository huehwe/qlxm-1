...
public class TonKhoForm extends javax.swing.JInternalFrame {
    ...
    public void loadDataToTable() {
        try {
            ...
            ArrayList<XeMay> arxm = xmdao.selectAllE();
    ...
    private void initComponents() {
        ...
        jComboBoxLuaChon.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Mã xe", "Tên xe", "Số lượng", "Đơn giá", "Phân khối", "Tên động cơ", "Tiêu thụ nhiên liệu", "Độ cao yên xe", "Xuất xứ" }));
    ...
    public void xoaXeMaySelect() {
        ...
        if (luaChon == JOptionPane.YES_OPTION) {
            XeMayDAO.getInstance().delete(getXeMaySelect());
    ...
    public XeMay getXeMaySelect() {
        int i_row = tblSanPham.getSelectedRow();
        XeMay acc = XeMayDAO.getInstance().selectAll().get(i_row);
        return acc;
    }
